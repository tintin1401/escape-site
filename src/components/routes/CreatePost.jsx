            ...
            <main className="flex lg:px-12 px-5 h-screen overflow-x-hidden justify-center content-center mx-auto w-full"
                ...
                <div className="flex items-center justify-center min-h-screen w-full">
                    <form onSubmit={handleCreatePost} className="max-w-[400px] w-full mx-auto gap-8 p-6 bg-white rounded-lg shadow dark:bg-[#404040]">
                        <h1 className='text-center text-xl font-bold mb-8 dark:text-white'>{t('CreatePost')}</h1>
                        ...
                        <button type="submit" className="text-white bg-sky-400 p-2 rounded-lg w-full mt-4 font-bold text-lg">{t('BtnPost')}</button>
                    </form>
                </div>
            </main>
        </div>
