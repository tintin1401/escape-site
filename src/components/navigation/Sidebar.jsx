    ...
    return(
        <div className={`bg-white dark:bg-[#2a2a2a] h-[100vh] pt-5 pb-5 pl-3 pr-4 cursor-pointer fixed top-0 left-0`} style={{ width: sidebarWidth, transition: "width 0.5s ease" }}>
            ...
            {user && user.user_type_id === 1 && (
                <NavLink to="/create-post" className="relative group mt-[10px] mb-[10px] w-full h-[45px] flex justify-center items-center rounded-lg bg-[#FFD8E4] hover:bg-[#f8c3d4] dark:hover:bg-[##404040] transition-colors duration-300 cursor-pointer" >
            ...
            <nav>
                <ul>
                    <li className="flex mb-[10px] mt-[10px]">
                        <NavLink onClick={() => selectItem(0)} to="/home" className={`relative group w-full h-[45px] flex items-center rounded-lg transition-colors duration-300 cursor-pointer ${selecItem === 0 ? 'bg-[#E8DEF8] dark:bg-[#484848]' : 'hover:bg-[#E8DEF8] dark:hover:bg-[#484848]'}`}>
                    ...
                    <li className="flex mb-[10px] mt-[10px]">
                        <NavLink onClick={() => selectItem(1)} to={profileUrl} className={`relative group w-full h-[45px] flex items-center rounded-lg transition-colors duration-300 cursor-pointer ${selecItem === 1 ? 'bg-[#E8DEF8] dark:bg-[#484848]' : 'hover:bg-[#E8DEF8] dark:hover:bg-[#484848]'}`}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6 min-w-[50px] dark:stroke-white">
                    ...
                    <li className="flex mb-[10px] mt-[10px]">
                        <NavLink onClick={() => selectItem(2)} to="/mapWithRoute" className={`relative group w-full h-[45px] flex items-center rounded-lg transition-colors duration-300 cursor-pointer ${selecItem === 2 ? 'bg-[#E8DEF8] dark:bg-[#484848]' : 'hover:bg-[#E8DEF8] dark:hover:bg-[#484848]'}`}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6 min-w-[50px] dark:stroke-white">
                    ...
                    <li className="flex mb-[10px] mt-[10px]">
                        <NavLink onClick={() => selectItem(3)} to="/favorites" className={`relative group w-full h-[45px] flex items-center rounded-lg transition-colors duration-300 cursor-pointer ${selecItem === 3 ? 'bg-[#E8DEF8] dark:bg-[#484848]' : 'hover:bg-[#E8DEF8] dark:hover:bg-[#484848]'}`}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6 min-w-[50px] dark:stroke-white">
