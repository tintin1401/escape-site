    ...
    <div className="grid justify-center items-center h-[100vh] md:grid-cols-2 gap-4">
      <div className="flex justify-center items-center">
        <form className="w-full lg:w-2/4 " onSubmit={handleSubmit}>
          <img
            className="w-[12rem] mx-auto mt-8 mb-12 "
            src={logo}
            alt="Logo"
          />
          <h2 className="text-4xl font-bold text-center mb-8 text-sky-500">
            {t("login")}
          </h2>
          <AuthInput
            name="email"
          ...
          <div className="text-right">
            <NavLink className="text-sky-500 font-medium" to="/forgot-password">
              {t("forgotPassword")}
            </NavLink>
          </div>
          <input
          ...
          <p className="text-gray-400 text-center dark:text-white">
            {t("goSignUp")}
            <NavLink className="text-sky-500 ml-2 font-medium" to="/signUpUser">
              {t("createAccount")}
            </NavLink>
          </p>
        </form>
